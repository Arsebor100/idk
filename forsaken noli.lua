...
deactivateBtn.Size = UDim2.new(0, 80, 0, 80)
...
playerCloseBtn.MouseButton1Click:Connect(closeAllMenus)
closeBtn.MouseButton1Click:Connect(closeAllMenus)
...
print("NoliGUI загружен с кнопкой DEACTIVATE")
