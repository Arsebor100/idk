...
disableBtn.Size = UDim2.new(0, 70, 0, 70)
disableBtn.Position = UDim2.new(1, -180, 0.5, 150) -- Позиция внизу, чтобы не мешала
disableBtn.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
disableBtn.Text = "X"
disableBtn.TextColor3 = Color3.new(1, 1, 1)
disableBtn.TextScaled = true
disableBtn.Font = Enum.Font.GothamBlack
Instance.new("UICorner", disableBtn).CornerRadius = UDim.new(1, 0)
