...
text.TextColor3 = Color3.fromRGB(255,35,35)
...
TweenService:Create(glow,TweenInfo.new(0.35,Enum.EasingStyle.Quart),{
    Size = UDim2.new(0,650,0,4)
}):Play()
...
TweenService:Create(intro,TweenInfo.new(0.35),{
    BackgroundTransparency = 1
}):Play()
